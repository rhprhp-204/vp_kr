...
SELECT 'PROMOTION_ANTANANARIVO', 'TXT_KEY_CITYSTATE_ANTANANARIVO', 'TXT_KEY_CSTRAIT_MINOR_CIV_ANTANANARIVO', 1, 'AS2D_IF_LEVELUP', 7, 'UCS2_ATLAS', 'PEDIA_ATTRIBUTES', 'TXT_KEY_CITYSTATE_ANTANANARIVO' UNION ALL
SELECT 'PROMOTION_BELGRADE', 'TXT_KEY_CITYSTATE_BELGRADE', 'TXT_KEY_CSTRAIT_MINOR_CIV_BELGRADE', 1, 'AS2D_IF_LEVELUP', 8, 'UCS2_ATLAS', 'PEDIA_ATTRIBUTES', 'TXT_KEY_CITYSTATE_BELGRADE' UNION ALL
SELECT 'PROMOTION_HANOI', 'TXT_KEY_CITYSTATE_HANOI', 'TXT_KEY_CSTRAIT_MINOR_CIV_HANOI', 1, 'AS2D_IF_LEVELUP', 9, 'UCS2_ATLAS', 'PEDIA_ATTRIBUTES', 'TXT_KEY_CITYSTATE_HANOI' UNION ALL
SELECT 'PROMOTION_MBANZA_KONGO', 'TXT_KEY_CITYSTATE_MBANZA_KONGO', 'TXT_KEY_CSTRAIT_MINOR_CIV_MBANZA_KONGO', 1, 'AS2D_IF_LEVELUP', 11, 'UCS2_ATLAS', 'PEDIA_ATTRIBUTES', 'TXT_KEY_CITYSTATE_MBANZA_KONGO' UNION ALL
SELECT 'PROMOTION_SIDON', 'TXT_KEY_CITYSTATE_SIDON', 'TXT_KEY_CSTRAIT_MINOR_CIV_SIDON', 1, 'AS2D_IF_LEVELUP', 13, 'UCS2_ATLAS', 'PEDIA_ATTRIBUTES', 'TXT_KEY_CITYSTATE_SIDON' UNION ALL
SELECT 'PROMOTION_YEREVAN', 'TXT_KEY_CITYSTATE_YEREVAN', 'TXT_KEY_CSTRAIT_MINOR_CIV_YEREVAN', 1, 'AS2D_IF_LEVELUP', 14, 'UCS2_ATLAS', 'PEDIA_ATTRIBUTES', 'TXT_KEY_CITYSTATE_YEREVAN';
